 ...
 * (lista_borrar, lista_borrar_en_posicion o lista_destruir) se invoca al destructor
 * pasandole el elemento.
 * NOTA: NO se aplica el destructor cuando se hace uso de la lista como pila o como
 * cola (es decir, no se aplica para desapilado ni desencolado).
 */
 ...
 * No necesariamente necesita recibir un destructor (puede recibir NULL si no se necesita).
 * Devuelve un puntero a la lista creada o NULL en caso de error.
 */
lista_t* lista_crear(lista_liberar_elemento destructor_de_elementos);
